...
for iMCMC1 = 1:MCMCSamps1
    ...
    %
    % Do a1 first
    [a2m1, a2v1] = HierMeanVarSampUniv(a1,a2v1,0,1,sigmean1, lambda1); 
    [e2m1, e2v1] = HierMeanVarSampUniv(e1,e2v1,0,1,sigmean1, lambda1); 
    [d2m1, d2v1] = HierMeanVarSampUniv(d1,d2v1,0,1,sigmean1, lambda1); 
