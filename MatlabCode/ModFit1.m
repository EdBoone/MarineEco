...
for i = 1:r1
    ...
    lpost1 = lpost1 + LVLogPost1(F01,R11, priorm1(i,:), priorsd1(i,:), ...
...
for iMCMC1 = 1:MCMCSamps1
    ...
    for i = 1:r1
        ...
        rates = [a1(i), b1c, e1(i), c1(i) ];
        lpost1c = LVLogPost1(F01,R11, priorm1, priorsd1, ...
                        rates, initial_cond,start_t1,end_t1);
        rand1u = rand(1,1);
